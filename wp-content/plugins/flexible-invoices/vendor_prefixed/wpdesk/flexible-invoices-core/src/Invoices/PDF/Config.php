...
final class Config
{
     ...
     * @var array
     */
    private $config = ['mode' => 'utf-8', 'format' => 'A4', 'orientation' => 'P', 'autoLangToFont' => \true, 'img_dpi' => 72, 'dpi' => 72, 'tempDir' => '', 'fontDir' => [], 'default_font' => 'freeserif', 'default_font_size' => 9, 'fontdata' => [], 'margin_left' => 0, 'margin_right' => 0, 'margin_top' => 0, 'margin_bottom' => 0, 'margin_header' => 0, 'margin_footer' => 0];
    /**
     * @param string $value
     *
     * @return Config
