...
class SettingsForm implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    private function get_settings_tabs()
    {
        ...
        if (empty($tabs)) {
            ...
            $tabs[\WPDeskFIVendor\WPDesk\Library\FlexibleInvoicesCore\Settings\Tabs\InvoiceTemplate::get_tab_slug()] = new \WPDeskFIVendor\WPDesk\Library\FlexibleInvoicesCore\Settings\Tabs\InvoiceTemplate();
            /**
