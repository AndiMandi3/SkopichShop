...
abstract class AbstractDataSource implements \WPDeskFIVendor\WPDesk\Library\FlexibleInvoicesCore\Data\SourceData
{
    ...
    {
        $name = isset($this->recipient['name']) ? $this->recipient['name'] : '';
        $street = isset($this->recipient['street']) ? $this->recipient['street'] : '';
        $street2 = isset($this->recipient['street2']) ? $this->recipient['street2'] : '';
        $postcode = isset($this->recipient['postcode']) ? $this->recipient['postcode'] : '';
        $city = isset($this->recipient['city']) ? $this->recipient['city'] : '';
        $vat_number = isset($this->recipient['nip']) ? $this->recipient['nip'] : '';
        $country = isset($this->recipient['country']) ? $this->recipient['country'] : '';
        $phone = isset($this->recipient['phone']) ? $this->recipient['phone'] : '';
        $email = isset($this->recipient['email']) ? $this->recipient['email'] : '';
