...
?></label>
            <?php 
$selected = !empty($seller->get_signature_user()) ? $seller->get_signature_user() : '';
\wp_dropdown_users(['role__in' => ['administrator', 'shop_manager', 'editor'], 'name' => 'owner[signature_user]', 'id' => 'inspire_invoices_owner_signature_user', 'selected' => $selected]);
?>
        </div>
    </div>
</div>
