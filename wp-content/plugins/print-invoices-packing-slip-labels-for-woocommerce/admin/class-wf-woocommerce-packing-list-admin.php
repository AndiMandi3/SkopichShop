...
class Wf_Woocommerce_Packing_List_Admin {
	...
	*/
	...
	public function plugin_action_links($links) 
	{
	   ...
	   $links[] = '<a href="https://www.webtoffee.com/product/woocommerce-pdf-invoices-packing-slips/?utm_source=free_plugin_listing&utm_medium=pdf_basic&utm_campaign=PDF_invoice&utm_content='.WF_PKLIST_VERSION.'" target="_blank">'.__('Upgrade to premium','print-invoices-packing-slip-labels-for-woocommerce').'</a>';
