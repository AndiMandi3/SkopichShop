...
.wfte_address-field-header{ font-weight:bold; font-size:12px; color:#000; padding:3px;}
...
<div class="wfte_rtl_main wfte_invoice-main"> 
    <div class="wfte_header_main">
        <div class="wfte_row wfte_padding_left_right wfte_header clearfix" style="margin-bottom:0px;">                  
    ...
    <div class="clearfix"></div>
    <div class="wfte_row wfte_body clearfix wfte_padding_left_right">
