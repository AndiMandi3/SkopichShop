...
.wfte_doc_title{ color:#23a8f9; font-size:30px; font-weight:bold; height:auto;}
...
.wfte_address-field-header{ font-weight:bold; font-size:12px; background:#eff1f4; color:#000; padding:3px; padding-left:7px;}
...
<div class="wfte_rtl_main wfte_invoice-main"> 
    <div class="wfte_header_main">
        <div class="wfte_row wfte_padding_left_right float_left wfte_header clearfix">       
            <div class="wfte_col-2 wfte_doc_title float_left">
                __[INVOICE]__
            </div>
            <div class="wfte_col-3 wfte_company_logo float_right" style="text-align:right;">
                <div class="wfte_company_logo_img_box">
                    <img src="[wfte_company_logo_url]" class="wfte_company_logo_img">
                </div>
                <div class="wfte_company_name wfte_hidden" style="text-align:right;">[wfte_company_name]</div>
                <div class="wfte_company_logo_extra_details" style="text-align:right;">__[]__</div>
            </div>
        </div>
    ...
    <div class="wfte_row wfte_body wfte_padding_left_right clearfix">
        <div class="wfte_addrss_field_main clearfix">
            <div class="wfte_col-3 float_left wfte_text_left">
                ...
                <div class="wfte_invoice_data" style="padding-left:6px;">
            ...
            <div class="wfte_col-3 float_right" style="text-align:right;">           
