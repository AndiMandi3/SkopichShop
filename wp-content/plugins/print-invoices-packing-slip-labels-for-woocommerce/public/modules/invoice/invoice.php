	...
	*/
	...
	public function add_frontend_print_buttons($html,$order,$order_id)
	{
		...
		if($show_on_frontend=='Yes')
		{
			...
			{
				Wf_Woocommerce_Packing_List::generate_print_button_for_user($order,$order_id,'print_invoice',esc_html__('Посмотреть и распечатать чек можно здесь','print-invoices-packing-slip-labels-for-woocommerce'));
			}
		}
		return $html;
	}
