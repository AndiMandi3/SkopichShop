...
function fstore_scripts() {
	wp_enqueue_style( 'fstore-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'fstore-style', 'rtl', 'replace' );

	wp_enqueue_script( 'fstore-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
