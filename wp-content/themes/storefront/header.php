			...
			<div class="my-nav" class="collapse navbar-collapse">
				<ul class="navbar-nav mr-auto nav-fill justify-content-center">
					<li class="nav-item col">
						<a class="nav-link" href="shop">Каталог <span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item col">
						<a class="nav-link" href="news-shoes" tabindex="-1" aria-disabled="true">Новинки</a>
					</li>
					<li class="nav-item col">
					...
					<li class="nav-item-icon col">
						<a class="nav-link" href="#" tabindex="-1" aria-disabled="true"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/Search.svg"></a>
					</li>
